# Generated by Django 6.0 on 2025-12-09 12:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('G', 'Gold'), ('S', 'Silver'), ('B', 'Bronze')], default='S', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('payment_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Confirm'), ('F', 'Failed')], default='P', max_length=1)),
